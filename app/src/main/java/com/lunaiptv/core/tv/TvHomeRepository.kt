...
class TvHomeRepository(
    ...
    private suspend fun publishRecentLiveProgram(
        profileId: Long,
        channelId: Long,
        channel: com.lunaiptv.core.database.entity.ChannelEntity,
        row: TvProviderProgramEntity,
        index: Int,
    ...
    private fun isHidden(customizations: SectionCustomizations, channel: com.lunaiptv.core.database.entity.ChannelEntity): Boolean =
