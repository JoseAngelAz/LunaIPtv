...
import com.lunaiptv.di.appModule
...
class LunaIPtvApp : Application(), SingletonImageLoader.Factory, androidx.work.Configuration.Provider {
     ...
     * default UAs). Crossfade smooths the grid as images stream in. Memory cache at 15% + a 50 MB
     * disk cache eliminate redundant network fetches on cold start and fast scrolling.
     */
        ...
        ImageLoader.Builder(context)
            ...
            .diskCache {
                DiskCache.Builder()
                    ...
                    .maxSizeBytes(50L * 1024 * 1024) // 50 MB disk cache for posters/logos
                    .build()
            }
            .crossfade(true)
            .build()
