...
import com.lunaiptv.core.database.dao.MetadataDao
import com.lunaiptv.core.database.entity.MetadataCacheEntity
import com.lunaiptv.core.database.entity.MetadataMatchEntity
...
class MetadataRepository(
     ...
     */
    suspend fun resolveSeries(series: com.lunaiptv.core.database.entity.SeriesEntity): MetadataCacheEntity? {
        if (!settings.metadataConfig().enabled) return null
    ...
    suspend fun resolveEpisode(
        series: com.lunaiptv.core.database.entity.SeriesEntity,
        episode: com.lunaiptv.core.database.entity.EpisodeEntity,
    ): MetadataCacheEntity? {
        if (!settings.metadataConfig().enabled) return null
     ...
     */
    suspend fun clearSeries(series: com.lunaiptv.core.database.entity.SeriesEntity) {
        val localKey = seriesLocalKey(series)
    ...
    suspend fun seriesOverride(series: com.lunaiptv.core.database.entity.SeriesEntity): TmdbOverride? =
    ...
    suspend fun setSeriesOverride(series: com.lunaiptv.core.database.entity.SeriesEntity, title: String, year: Int?) {
    ...
    suspend fun clearSeriesOverride(series: com.lunaiptv.core.database.entity.SeriesEntity) {
    ...
    companion object {
        ...
        fun seriesLocalKey(series: com.lunaiptv.core.database.entity.SeriesEntity): String =
