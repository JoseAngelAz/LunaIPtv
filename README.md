...
<p align="center">
  ...
  <sub>Rapido · moderno · optimizado para control remoto — trae tus propias fuentes M3U o Xtream</sub>
</p>

<p align="center">
  <img alt="Plataforma" src="https://img.shields.io/badge/platform-Android%20TV-3DDC84?logo=android&logoColor=white">
  <img alt="Kotlin" src="https://img.shields.io/badge/Kotlin-2.3.10-7F52FF?logo=kotlin&logoColor=white">
  <img alt="Compose para TV" src="https://img.shields.io/badge/Jetpack%20Compose-for%20TV-4285F4?logo=jetpackcompose&logoColor=white">
  <img alt="Reproductor" src="https://img.shields.io/badge/engines-libmpv%20%2B%20ExoPlayer-FB8C00">
  <img alt="Licencia" src="https://img.shields.io/badge/license-GPLv3-blue">
  <img alt="Construido con ayuda de AI" src="https://img.shields.io/badge/built%20with-the%20help%20of%20AI-8A2BE2">
</p>
...
> **IMPORTANT — NO COBROS / NO CHARGES:**
> **Nadie debe pagar por esta aplicacion ni por el APK de LunaIPtv.** Nadie esta autorizado a vender, cobrar o solicitar cualquier suma de dinero por esta aplicacion, el APK, o cualquier copia de ella. Si alguien te cobra por LunaIPtv, esta violando los terminos de la licencia GPLv3. **LunaIPtv es y siempre sera gratuito.**
>
> **Nobody should pay for this application or the LunaIPtv APK.** No one is authorized to sell, charge, or request any payment for this application, the APK, or any copy of it. If someone charges you for LunaIPtv, they are violating the GPLv3 license terms. **LunaIPtv is and will always be free.**
